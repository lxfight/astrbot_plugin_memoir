...
Group capture normally runs through a non-activating custom filter. Native STT
voice capture runs after preprocessing without asking the main model to reply.
